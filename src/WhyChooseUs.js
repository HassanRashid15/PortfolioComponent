  ...
  return (
    <div ref={sectionRef} className=" mx-auto px-6 py-12" style={{maxWidth:'85%'}}>
      <div className="text-center mb-12">
        ...
        <div
          className="w-12 h-1 mx-auto mt-5"
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div className="space-y-4">
          <p className="text-gray-700">
            ...
            officia deserunt mollit anim id est laborum. Sed perspiciatis unde
            omnis an natus error sit voluptatem.
          </p>
          <p className="text-gray-500">
            Totam rem aperiam eaque ipsa quae illo inventore veritatis et quasi
